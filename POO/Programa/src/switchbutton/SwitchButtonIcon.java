 ...
 * @author RAVEN
 */
public class SwitchButtonIcon extends javax.swing.JPanel {
    ...
    ColorFilter colorFilterOn = new ColorFilter(color -> ColorFilterOn);
    ColorFilter colorFilterOff = new ColorFilter(color -> ColorFilterOff);
    ...
    public SwitchButtonIcon() {
        initComponents();
        lbOn.setIcon(svgIconOn);
        lbOff.setIcon(svgIconOff);
        init();
    }
