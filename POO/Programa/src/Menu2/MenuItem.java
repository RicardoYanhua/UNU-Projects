...
public class MenuItem extends JPanel {
    ...
    private void init(ModelMenuItem item) {
        ...
        setLayout(new MigLayout("wrap,fillx,inset 0", "[fill]", "[fill,55!]" + (hasSubMenu ? "0[fill,30!]" : "")));
    ...
    void initAnimator(MigLayout layout) {
    ...
    private void createShadow(Graphics grphcs) {
        ...
        //  Create Shadow
        ShadowRenderer render = new ShadowRenderer(11, 0.9f, SystemColor.MAIN_COLOR_3);
        g2.drawImage(render.createShadow(img), 11, 10, null);
