...
public class MenuText extends JPanel {
    ...
    private Color Menu_ColorSeparator = new Color(220,220,220);
    ...
    public MenuText() {
        ...
        addTitle("CONTROL");
        addButton(new FlatSVGIcon("svg/user.svg", IconSize, IconSize),"Button Namesasdadadadasdasdasd");
        addButton(new FlatSVGIcon("svg/user.svg", IconSize, IconSize),"Button Names");
        addButton(new FlatSVGIcon("svg/user.svg", IconSize, IconSize),"Button Names");
        addButton(new FlatSVGIcon("svg/user.svg", IconSize, IconSize),"Button Names");
        addSpace(10);
        addTitle("CONTROL");
        addButton(new FlatSVGIcon("svg/user.svg", IconSize, IconSize),"Button Names");
        addButton(new FlatSVGIcon("svg/user.svg", IconSize, IconSize),"Button Names");
        addButton(new FlatSVGIcon("svg/user.svg", IconSize, IconSize),"Button Namesd");
        addButton(new FlatSVGIcon("svg/user.svg", IconSize, IconSize),"Button Names");
        addSpace(10);
        addTitle("CONTROL");
        addButton(new FlatSVGIcon("svg/user.svg", IconSize, IconSize),"Button Names");
    ...
    private void InitLayoutMenu() {
        setLayout(new MigLayout("wrap,fillx, insets 20 0 10 0,gapy 0", "[fill]", "[fill][fill][fill,grow][fill][fill]"));
    }
    ...
    private JPanel CreatePanelMenu() {
        ...
        PanelMenu.setLayout(new MigLayout("wrap, fillx,insets 0 5 0 7, gapy 3", "[fill]"));
        return PanelMenu;
    }

    private void addButton(FlatSVGIcon icon, String text) {
        ButtonItemMenu itembutton = new ButtonItemMenu(icon, Menu_ButtonColorIconandTextDefault, text, ++IndexButton);
    ...
    public void addTitle(String title) {
        ...
        label.setBorder(new EmptyBorder(15, 10, 0, 5));
        label.setFont(new Font(FlatRobotoFont.FAMILY, Font.BOLD, 12));
        label.setForeground(Menu_ButtonColorIconandTextDefault.brighter());
        PanelBotones.add(label);
    }

    public void addSpace(int size) {
        PanelBotones.add(new JLabel(), "h " + size + "!");
    }
