...
public class ScrollPaneWin11 extends JScrollPane {
    ...
    public ScrollPaneWin11(Color ScrollColor,boolean ActivedButtons) {
        getVerticalScrollBar().setUI(new ScrollBarWin11UI(ScrollColor,ActivedButtons));
        getHorizontalScrollBar().setUI(new ScrollBarWin11UI(ScrollColor,ActivedButtons));
