...
public class CardFactura extends javax.swing.JPanel {

    private DocumentFactura data;

    public DocumentFactura getData() {
        return data;
    }
    ...
    public CardFactura() {
        ...
        lbIcon.setIcon(new FlatSVGIcon("svg/factura.svg", 54, 54));
    }
   
    

    public void setData(DocumentFactura data) {
        this.data = data;
        lbCodigo.setText(data.getCodigo());
        lbImporte.setText(data.getImporte());
        lbNombre.setText(data.getRUC());
    ...
    private void initComponents() {
        ...
        jPanel3.add(lbCodigo, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 20, 120, -1));
