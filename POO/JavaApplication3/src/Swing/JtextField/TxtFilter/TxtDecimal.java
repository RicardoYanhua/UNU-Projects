...
public abstract class TxtDecimal extends PlainDocument {
    ...
    public TxtDecimal(int DecimalSize) {
        this.Decimal_Limit = DecimalSize;
    }

    public  String truncar(String stringDecimal) {
        // Dividimos el string en la parte entera y decimal
