...
public class SwitchButtonText extends javax.swing.JPanel {
    ...
    FlatSVGIcon svgIconOn;
    FlatSVGIcon svgIconOff;

    Color ColorFilterOn = new Color(0, 0, 0);
    Color ColorFilterOff = new Color(0, 0, 0);

    FlatSVGIcon.ColorFilter colorFilterOn = new FlatSVGIcon.ColorFilter(color -> ColorFilterOn);
    FlatSVGIcon.ColorFilter colorFilterOff = new FlatSVGIcon.ColorFilter(color -> ColorFilterOff);

    public FlatSVGIcon getSvgIconOn() {
        return svgIconOn;
    }

    public void setSvgIconOn(FlatSVGIcon svgIconOn) {
        this.svgIconOn = svgIconOn;
        this.svgIconOn.setColorFilter(this.colorFilterOn);

        lbOn.setIcon(this.svgIconOn);
    }

    public FlatSVGIcon getSvgIconOff() {
        return svgIconOff;
    }

    public void setSvgIconOff(FlatSVGIcon svgIconOff) {
        this.svgIconOff = svgIconOff;
        this.svgIconOff.setColorFilter(this.colorFilterOff);
        lbOff.setIcon(this.svgIconOff);

    }

    public Color getColorFilterOn() {
        return ColorFilterOn;
    }

    public void setColorFilterOn(Color ColorFilterOn) {

        this.ColorFilterOn = ColorFilterOn;
    }

    public Color getColorFilterOff() {
        return ColorFilterOff;
    }

    public void setColorFilterOff(Color ColorFilterOff) {
        this.ColorFilterOff = ColorFilterOff;
    }
    ...
    private void createBorder(Graphics2D g2, int width, int height) {
        ...
        //g2.fillRoundRect(borderSize, borderSize, width - borderSize * 2, height - borderSize * 2, round, round);
    ...
    private void createSwitch(Graphics2D g2, int width, int height) {
        ...
        g2.setColor(getBackground());
        g2.fillRoundRect(borderSize, borderSize, width - borderSize * 2, height - borderSize * 2, r, r);
    ...
    private void initComponents() {
        ...
        lbOn.setText("On");
        lbOn.setHorizontalTextPosition(javax.swing.SwingConstants.LEADING);
        lbOn.setMaximumSize(new java.awt.Dimension(27, 22));
        lbOn.setMinimumSize(new java.awt.Dimension(27, 22));

        lbOff.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lbOff.setText("Off");
        lbOff.setHorizontalTextPosition(javax.swing.SwingConstants.LEADING);
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(lbOff, javax.swing.GroupLayout.DEFAULT_SIZE, 40, Short.MAX_VALUE)
