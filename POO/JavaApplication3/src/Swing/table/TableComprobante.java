...
import Util.Scroll.ModernScrollBarUI;
import Util.Scroll.ScrollBar;
import Util.Scroll.ScrollBarCustom;
...
public class TableComprobante extends JTable {

    public TableComprobante() {
        ...
        getTableHeader().setDefaultRenderer(new DefaultTableCellRenderer() {
            ...
            public Component getTableCellRendererComponent(JTable jtable, Object o, boolean bln, boolean bln1, int i, int i1) {
                ...
                TableHeader header = new TableHeader(o + "", true);
