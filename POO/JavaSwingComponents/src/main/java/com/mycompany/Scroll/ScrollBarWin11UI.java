...
public class ScrollBarWin11UI extends BasicScrollBarUI {
    ...
    private final int scrollSize = 7;
    private final MouseAdapter mouseEvent;
    private Color ScrollColor;
    private boolean Buttons = true;

    public ScrollBarWin11UI(Color ScrollColorUI, boolean activedButton) {
        this.ScrollColor = ScrollColorUI;
        this.Buttons = activedButton;
    ...
    public void installUI(JComponent c) {
        ...
        c.setForeground(this.ScrollColor);
        initAnimator();
    }
    ...
    protected void paintThumb(Graphics g, JComponent c, Rectangle thumbBounds) {
        ...
        g2.setRenderingHint(RenderingHints.KEY_ANTIALIASING, RenderingHints.VALUE_ANTIALIAS_ON);
        g2.setColor(ScrollColor);
        double border = scrollSize * 0f - (animate * 1);
        double sp = 10 * animate;
        g2.setComposite(AlphaComposite.SrcOver.derive(1f - (1f - animate * 0.1f) * 0.8f));
