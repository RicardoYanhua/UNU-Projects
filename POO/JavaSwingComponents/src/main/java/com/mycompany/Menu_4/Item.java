...
public class Item extends JButton {
    ...
    private final Color mainColor = Color.RED;
    ...
    protected void paintComponent(Graphics g) {
        ...
        if (!mainMenu) {
            ...
            if (isSelected()) {
                Graphics2D g2 = (Graphics2D) g.create();
                g2.setRenderingHint(RenderingHints.KEY_ANTIALIASING, RenderingHints.VALUE_ANTIALIAS_ON);
                g2.setPaint(new GradientPaint(0, 3, Color.GREEN, 3, getHeight() - 6, Color.GREEN));
    ...
    public void setGoogleIcon(FlatSVGIcon icon) {
        if (icon != null) {
            this.icon = icon;
            setIcon(new FlatSVGIcon("svg/user.svg", 20, 20));
        }
    }
