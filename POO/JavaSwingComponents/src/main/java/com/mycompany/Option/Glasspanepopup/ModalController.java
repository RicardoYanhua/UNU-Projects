...
public class ModalController extends JPanel {
    ...
    private Stack<Component> modalStack;
    ...
    private void pushStack(Component modal) {
        if (modalStack == null) {
    ...
    public void addModal(Component modal) {
        ...
        panelSlider.addSlide(modal, SimpleTransition.get(SimpleTransition.SliderType.ZOOM_IN));
        this.modal = modal;
    }
            ...
            if (animator == null) {
                animator = new Animator(option.getDuration(), new Animator.TimingTarget() {
                    ...
                    public void begin() {
                        ...
                        snapshotsImage = ImageSnapshots.createSnapshotsImage(panelSlider);
