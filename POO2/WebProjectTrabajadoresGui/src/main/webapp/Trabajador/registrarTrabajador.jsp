...
<div class = "content-form">
	...
	<div class="form-group">
			...
			<input class="form-control" type = "number" placeholder="Ingresar DNI" id = "dni" name ="dni" required>
		</div>
  ...
  %>
		...
		<div class = "form-group">
			...
			<input  class="form-control" type = "text" id = "nafp" name = "nafp" required>
		</div>
	
		<div class = "form-group">
			<label for = "codEsalud">Codigo Esalud </label>
			<input  class="form-control" type = "text" id = "codEsalud" name = "codEsalud" required>
		</div>
  ...
  %>
	...
	<div style = "display:flex;justify-content: flex-end;padding: 20px 0px">
		...
		<input  class="btn btn-primary" onclick="return message()" type = "submit" value = "Registrar Trabajdor"> 
	</div>
