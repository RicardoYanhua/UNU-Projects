...
public class SpinnerHora extends JSpinner {

    public SpinnerHora() {
        setOpaque(false);
        int Horaactual = LocalDateTime.now().getHour(); // Obtiene el dia actual
        setModel(new SpinnerNumberModel(0, 0, 23, 1)); // Rango de 1 a 31
        setValue(Horaactual); // Valor inicial
        setUI(new SpinnerUIHora());
    }

    
}

class SpinnerUIHora extends BasicSpinnerUI {
