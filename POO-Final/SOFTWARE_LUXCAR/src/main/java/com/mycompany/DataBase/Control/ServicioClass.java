...
public class ServicioClass {
    ...
    public ServicioClass(int IDServicio, String Ubicacion, String Descripcion, String Estado, LocalDateTime FechaInicio, LocalDateTime FechaServicoRegistrado, LocalDateTime FechaFinalizacion) {
        this.IDServicio = IDServicio;
        this.Ubicacion = Ubicacion;
        this.Descripcion = Descripcion;
        this.Estado = Estado;
