...
public class TrabajadorClass {
    ...
    public TrabajadorClass(String DNI, String Nombres, String Apellidos, LocalDate FechaNacimiento, String Direccion, String Correo, String Telefono, LocalDate FechaContratacion, String Puesto, double HoraCobro, String Genero, String Estado, byte[] Foto) {
        this.DNI = DNI;
        this.Nombres = Nombres;
        this.Apellidos = Apellidos;
        this.FechaNacimiento = FechaNacimiento;
