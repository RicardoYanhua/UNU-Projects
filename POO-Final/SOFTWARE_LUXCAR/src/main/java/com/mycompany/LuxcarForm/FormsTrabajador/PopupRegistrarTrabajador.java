...
public class PopupRegistrarTrabajador extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        panel1.add(button2, new org.netbeans.lib.awtextra.AbsoluteConstraints(1130, 700, 130, 50));
        ...
        panel1.add(BTN_ADD_PHOTO, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 510, 50, 50));
    ...
    private void button2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button2ActionPerformed
        if (ValidarDatosTrabajador()) {
            ...
            if (foto != null) {
                ...
                try {
                    NuevoTrabajador.setFoto(Utilidades.imageIconToBytes(foto));
                } catch (IOException ex) {
                    Logger.getLogger(PopupModificarTrabajador.class.getName()).log(Level.SEVERE, null, ex);
                }
            } else {
                NuevoTrabajador.setFoto(null);
