...
public class FormUsuario extends javax.swing.JPanel {
    ...
    public  static void getCountUsers() {
    ...
    public void InicializarIcons() {
        ...
        BTN_AGREGAR_USUSARIO.setIcon(
                new FlatSVGIcon("svg/user.svg", 25, 25));
    ...
    private static com.mycompany.Swing.Card.CardDataAction CARD_U_TRABAJADORES;
    private static com.mycompany.Swing.Card.CardDataAction CARD_U__NO_TRABAJADORES;
    private com.mycompany.Swing.Tabla.Tabla TABLA;
    private javax.swing.JLabel TITULO_BUSQUEDA;
    public static com.mycompany.Swing.TextField.TextField TXT_BUSQUEDA;
